...
```{r reporting8, echo=TRUE, results="markup", include=TRUE, warning=TRUE, message=TRUE, fig.width=5, fig.height=4}
...
```{r reporting9, echo=TRUE, results="markup", include=TRUE, warning=TRUE, message=TRUE, fig.width=5, fig.height=4}
...
```{r reporting28, echo=TRUE, results="markup", include=TRUE, warning=TRUE, message=TRUE, fig.width=5, fig.height=4}
